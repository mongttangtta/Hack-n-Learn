...
export const xssQuizProblems: Problem[] = [
  {
    id: 1,
    category: '분류',
    question:
...
export const sqlInjectionQuizProblems: Problem[] = [];
export const commandInjectionQuizProblems: Problem[] = [];

export const quizzes: { [key: string]: Problem[] } = {
  'xss': xssQuizProblems,
  'sql-injection': sqlInjectionQuizProblems,
  'command-injection': commandInjectionQuizProblems,
};
